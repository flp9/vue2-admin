...
---
 ...
 以网上vue项目为模板，在此基础上加入自己的一些项目需求，一路上遇到了许多问题，都是通过google来自己研究解决。在这个过程中学到了许多，于是决定把最基础的部分拿出来，单独做一个项目，以后再遇到类似的后台系统，直接可以拿过来用，免去了一开始的搭建环境、写基础代码的麻烦。同时也想分享出来，与大家交流交流，哈哈。
如果觉得还可以的话，麻烦给点个⭐⭐，谢谢各位喽😊
## github:  [https://github.com/flpffcssqfjh/vue-admin.git](https://github.com/luichooy/vue-admin.git)
...
```plain
# 将项目克隆到本地
https://github.com/flpffcssqfjh/vue-admin.git
