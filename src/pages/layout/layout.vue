    ...
    <div class="siderbar-wrapper" :style="{width: this.isCollapsed?'64px':'200px'}">
      ...
      <el-menu
        ...
        <template v-for="(item, index) in sider_menu_data">
          <el-menu-item class="menu-item" v-if="!item.children" :index="item.path" :key="index" :route="item.path">
            <i :class="item.icon"></i>
          ...
          <el-submenu v-else :index="item.path">
            ...
            <el-menu-item class="menu-item" v-for="(sub_item, sub_index) in item.children" :index="sub_item.path"
                          :key="sub_index" :route="sub_item.path">
        ...
        <li v-if="user" class="menu-item" style="padding: 0;">
          <el-dropdown
            ...
            <el-dropdown-menu slot="dropdown">
              ...
              <el-dropdown-item command="b">{{user.name}}11</el-dropdown-item>
...
<script>
  ...
  export default {
        ...
        sider_menu_data: [
          ...
          },
          {
            ...
            children: [
              ...
              {path: '/tables/sort', title: '筛选分页'},
              {path: '/tables/filter', title: '表格添加行'},
              {path: '/tables/AddRow', title: '添加行'}
            ]
          },
          {
            path: '/charts',
    ...
    methods: {
      // toLink() {
      //   console.log('111')
      //   // this.$router.replace('/TestRouter');
      //   // console.log('000', this.$router)
      // },
      checkAuth() {
