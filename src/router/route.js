    ...
    children: [
      {
        ...
        name: 'CalendarTest',
        title: '测试00',
        component: () => import('src/components/CalendarTest/CalendarTest')
      }
    ]
  }
];
...
export const appRouter = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: 'AddRow',
        title: '添加行',
        component: () => import('src/pages/tables/AddRow')
      }
    ]
  },
  {
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: 'select',
        title: '表单多选',
        component: () => import('src/pages/form/render/select')
      }
    ]
  },
  {
